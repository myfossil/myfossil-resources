...
class myFOSSIL_Resources
{
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action( 'wp_ajax_myfr_filter_end_date', $plugin_public,
                'ajax_handler' );
        $this->loader->add_action( 'wp_ajax_myfr_list_events_states', $plugin_public,
                'ajax_handler' );
        $this->loader->add_action( 'wp_ajax_myfr_list_events_types', $plugin_public,
                'ajax_handler' );
        $this->loader->add_action( 'wp_ajax_myfr_list_events_month_years', $plugin_public,
                'ajax_handler' );
        ...
        $this->loader->add_action( 'wp_ajax_nopriv_myfr_list_events_states', $plugin_public,
                'ajax_handler' );
        $this->loader->add_action( 'wp_ajax_nopriv_myfr_list_events_types', $plugin_public,
                'ajax_handler' );
        $this->loader->add_action( 'wp_ajax_nopriv_myfr_list_events_month_years', $plugin_public,
                'ajax_handler' );
    }
